...
if (!$@) {
    ...
    $mock->fake_module('Handel::Test::RDBO::Checkout');
    $mock->fake_new('Handel::Test::RDBO::Checkout');
...
sub run {
    ...
    {
        try {
            my $cart = Handel::Test::RDBO::Cart->search({
                id => '00000000-0000-0000-0000-00000000000' . $dbsuffix
            })->first;
            my $order = $subclass->create({cart => $cart});
...

    {
        ...
        my $cart = Handel::Test::RDBO::Cart->create({
